...
// import SingleImg from '../../assets/image/pic2.jpg'
  ...
  return (
    <div className="singlePost">
      <div className="singlePostWrapper">
        {post.photo && (
          <img src={PF + post.photo} alt="Post Img" className="singlePostImg" />)}
        ...
        {
          updateMode ? (<textarea className="singlePostDecInput" value={desc} onChange={(e)=>setDesc(e.target.value)} autoFocus/>) : (
